/*
  # Add example tickets and chat conversations

  This migration adds example tickets and chat conversations to demonstrate
  the different types of conversations in the system.

  1. Changes
    - Adds example email tickets
    - Adds example chat conversations
    - Assigns conversations to appropriate teams and agents
  ...
  2. Data
    - Creates tickets for:
      ...
      - Bug report
      - Billing inquiry
    - Creates chat conversations for:
      - Technical support
      - Sales inquiry
      - General support
*/
