/*
  # Add Webhook Events Table and Functions

  1. New Tables
    - `webhook_events` - Stores history of webhook events
      - `id` (uuid, primary key)
  ...
  2. Functions
    - `update_webhook_last_triggered` - Updates the last_triggered timestamp on webhooks

  3. Security
    - Enable RLS on webhook_events table
    - Add policy for authenticated users with system configuration permissions
*/
...
-- Add description field to webhooks table if it doesn't exist
