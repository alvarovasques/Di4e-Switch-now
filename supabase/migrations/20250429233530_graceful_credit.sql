/*
  # AI Conversation Logs Schema

  1. New Table
    - `ai_conversation_logs` - Stores detailed logs of AI interactions
      - Tracks prompts, responses, and performance metrics
      - Includes confidence scores and user feedback
      - Links to conversations and AI agents

  2. Functions
    - `calculate_ai_confidence()` - Computes average confidence scores
    - `trigger_ai_handoff()` - Transfers conversations from AI to human agents
