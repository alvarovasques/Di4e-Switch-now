...
CREATE POLICY "Only admins and managers can manage AI agent settings"
...
-- Create policies for ai_webhook_events
CREATE POLICY "Authenticated users can read AI webhook events"
...
BEGIN
  ...
  FOR webhook_record IN -- Use proper loop syntax with a RECORD variable
