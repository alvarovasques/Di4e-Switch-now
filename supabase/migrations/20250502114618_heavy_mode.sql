...
-- Create policies
CREATE POLICY "Authenticated users can read AI agent settings_new"
  ON ai_agent_settings FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "Only admins and managers can manage AI agent settings_new"
...
CREATE POLICY "Authenticated users can read AI webhook events_new"
