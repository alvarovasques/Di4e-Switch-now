/*
  # Fix AI Conversation Logs Table

  This migration creates the ai_conversation_logs table if it doesn't exist
  and properly checks for existing policies before creating them to avoid errors.
*/
